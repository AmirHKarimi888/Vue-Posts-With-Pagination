...
<template>
    <div class="dashboard">
        <div class="admin mx-auto mt-[200px] w-[330px] rounded-xl p-9 text-center border dark:border-gray-700 dark:bg-gray-950 dark:text-white">
